                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(role, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(88, 88, 88))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
       ...
       ResultSet Rs= null;
               if(role.getSelectedItem().toString().equals("Seller")){
                   String Query = "select * from Seller_Table where Sel_Name='"+name.getText()+"' and Sel_Pass='"+pass.getText()+"' ";
                   try{
                       Con = DriverManager.getConnection(url, user, password);
                        ...
                        if(Rs.next()){
                            ...
                            JOptionPane.showMessageDialog(this, "Wrong Seller name or password");
                        }
                    ...
                    String Query = "select * from Admin_Table where name='"+name.getText()+"' and password='"+pass.getText()+"' ";
                   try{
                       Con = DriverManager.getConnection(url, user, password);
                        St = Con.createStatement();
                        Rs = St.executeQuery(Query);
